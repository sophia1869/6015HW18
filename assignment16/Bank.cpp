...
Bank::Bank(double arrivingRate, double maxServiceTime, int seed){
...
void Bank::printRes(){
    ...
    std::cout<<"Bank service times in minutes: 10th %ile "<< this->history[this->history.size()*0.1] << ", 50th %ile "<< this->history[this->history.size()*0.5] <<", 90th %ile "<< this->history[this->history.size()*0.9] <<std::endl;
